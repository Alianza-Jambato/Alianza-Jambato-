...
![](images/Screenshot%202025-03-23%20at%2013.12.52.png)
...
![Fig 1.1. Frontend de ambient weather. En la parte derecha se puede ver un menú desplegable que permite especificar el periodo de tiempo para descargar los datos.](images/Screenshot%202025-03-23%20at%2012.51.21.png)
...
![Fig 1.2. Resumen mensual de datos. En este gráfico se pueden obtener los resúmenes mensuales.](Desktop/Screenshot%202025-03-23%20at%2012.57.18.png)

![Fig 1.3. Resumen de datos. Aquí finalmente se da click en en ícono de la derecha (con el círculo azul) y se procede a seleccionar todos los datos.)](Desktop/Screenshot%202025-03-23%20at%2013.00.32.png)
...
```{r}
#dfall$date <-  as.POSIXct(dfall$date, format="%Y-%m-%d")
```
...
leaflet() %>%
  addTiles() %>%
  addMarkers(lng = -78.93, lat = -1.12, popup = "1.12°S, 78.93°W") %>%
  setView(lng = -78.93, lat = -1.12, zoom = 8)
```
